...
{
    public partial class TranslationList : Form
    {
        private Main form1;
        ...
        public TranslationList(Main form1)
        {
            InitializeComponent();
            this.form1 = form1;

        }
        private void FormTranslationList_Load(object sender, EventArgs e)
        {
            ...
            label6.Text = workerSurname;
            label7.Text = position;
            label8.Text = cardNumber.ToString();
            label9.Text = salary.ToString();
        }
